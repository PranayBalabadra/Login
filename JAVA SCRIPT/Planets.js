...
{
   images[i-1].setAttribute("src","../Asste/image/planets/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../Asste/image/planets/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../Asste/image/planets/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../Asste/image/planets/'+pic+'.jpg'
