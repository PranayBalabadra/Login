...
{
   images[i-1].setAttribute("src","../Asste/image/blackhole/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../Asste/image/blackhole/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../Asste/image/blackhole/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../Asste/image/blackhole/'+pic+'.jpg'
