...
{
   images[i-1].setAttribute("src","../Asste/image/satellite/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../Asste/image/satellite/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../Asste/image/satellite/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../Asste/image/satellite/'+pic+'.jpg'
