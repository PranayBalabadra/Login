...
{
   images[i-1].setAttribute("src","../Asste/image/Stars/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../Asste/image/Stars/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../Asste/image/Stars/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../Asste/image/Stars/'+pic+'.jpg'
